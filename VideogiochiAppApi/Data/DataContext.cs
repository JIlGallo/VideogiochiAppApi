...
namespace VideogiochiAppApi.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configurazione della relazione M:M con Cascade Delete
            modelBuilder.Entity<VideogiocoProprietario>()
                .HasOne(vp => vp.Proprietario)
                .WithMany(p => p.VideogiocoProprietario)
                .HasForeignKey(vp => vp.IdProprietario)
                .OnDelete(DeleteBehavior.Cascade); // <-- Importante!

            modelBuilder.Entity<VideogiocoProprietario>()
                .HasOne(vp => vp.Videogioco)
                .WithMany(v => v.VideogiocoProprietario)
                .HasForeignKey(vp => vp.IdVideogioco)
                .OnDelete(DeleteBehavior.Cascade); // <-- Importante!
            ...
            // Seed data per VideogiocoProprietario
            modelBuilder.Entity<VideogiocoProprietario>().HasData(
                ...
                new VideogiocoProprietario { IdVideogiocoProprietario = 6, IdVideogioco = 3, IdProprietario = 5 },
                new VideogiocoProprietario { IdVideogiocoProprietario = 7, IdVideogioco = 2, IdProprietario = 7 },
                new VideogiocoProprietario { IdVideogiocoProprietario = 1, IdVideogioco = 1, IdProprietario = 2 }
